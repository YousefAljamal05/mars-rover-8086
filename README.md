...
The 8x8 grid is a 2D array in memory. Obstacles are calculated using the following modulo arithmetic for each student ID (d_1d_2d_3d_4d_5d_6d_7d_8):
 * Obstacle 1: Row = d_7 \text{ mod } 8, Col = d_8 \text{ mod } 8
 * Obstacle 2: Row = d_5 \text{ mod } 8, Col = d_6 \text{ mod } 8
 * Obstacle 3: Row = d_3 \text{ mod } 8, Col = d_4 \text{ mod } 8 (if needed)
